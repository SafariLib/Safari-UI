...
export const RollerTrailingWrapper = styled('div')(
    props => css`
        ...
        animation: SafariUI-loader-roller-trailing-spin 1.7s infinite ease,
            SafariUI-loader-roller-trailing-round 1.7s infinite ease;

        @keyframes SafariUI-loader-roller-trailing-spin {
            0% {
        ...
        @keyframes SafariUI-loader-roller-trailing-round {
            0% {
